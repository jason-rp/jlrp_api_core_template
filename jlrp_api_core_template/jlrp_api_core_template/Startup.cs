using jlrp_api_core_template.Infrastructure.Configs;
using jlrp_api_core_template.Infrastructure.Extensions;
...
namespace jlrp_api_core_template
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "jlrp_api_core_template ASP.NET Core API v1");
            });
